  ...
  try {
    ...
    if (createResponse.ok) {
      ...
      if (userId) {
        ...
        const updateResponse = await fetch(`${API_BASE}/api/admin/users/${encodeURIComponent(userId)}`, {
          method: 'PUT',
          headers,
          body: JSON.stringify({
        ...
        const deleteResponse = await fetch(`${API_BASE}/api/admin/users/${encodeURIComponent(userId)}`, {
          method: 'DELETE',
          headers
        })
