...
const defaultHero = (
  <div className="mx-auto max-w-xl text-center text-white lg:mx-0 lg:text-left">
    <span className="inline-flex items-center gap-2 rounded-full border border-white/30 bg-white/20 px-4 py-1 text-xs font-bold uppercase tracking-[0.3em] text-white backdrop-blur shadow-lg">
      <span className="h-2 w-2 rounded-full bg-accent" aria-hidden />
      MIHAS Student Portal
    </span>
    <div className="mt-6 space-y-4">
      <h1 className="text-4xl font-bold leading-tight sm:text-5xl text-white drop-shadow-lg">Grow your healthcare career with confidence</h1>
    ...
    <div className="mt-8 grid gap-4 sm:grid-cols-2">
      <div className="rounded-2xl border border-white/30 bg-white/20 p-4 text-left backdrop-blur shadow-lg">
        <p className="text-sm font-bold text-white drop-shadow-md">24/7 Access</p>
        <p className="mt-1 text-sm text-white font-medium drop-shadow-sm">Manage your journey from any device at any time.</p>
      </div>
      <div className="rounded-2xl border border-white/30 bg-white/20 p-4 text-left backdrop-blur shadow-lg">
        <p className="text-sm font-bold text-white drop-shadow-md">Dedicated Support</p>
        <p className="mt-1 text-sm text-white font-medium drop-shadow-sm">Our advisors are ready to help you take the next step.</p>
      </div>
    </div>
  </div>
)
